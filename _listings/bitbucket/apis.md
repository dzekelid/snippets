...
- name: Bitbucket Get Snippets Username Encoded  Revision Patch
  ...
  - type: x-postman-collection
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/snippets/master/_listings/bitbucket/snippets-username-encoded-id-revision-patch-get-postman.md
x-common:
- type: x-developer
