...
- name: Bitbucket Parameters Snippets Username Encoded  Commits
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/snippets/master/_listings/bitbucket/snippets-username-encoded-id-commits-parameters.md
  - type: x-postman-collection
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/snippets/master/_listings/bitbucket/snippets-username-encoded-id-commits-parameters-postman.md
x-common:
- type: x-developer
